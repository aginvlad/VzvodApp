...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nvar captains = exports.captains = [{\n    id: 0,\n    rank: 'КВ',\n    name: 'Сыантович Алексей',\n    phone: '+375 29 3840198',\n    photo: 'img/user.png'\n}, {\n    id: 1,\n    rank: 'КО 1',\n    name: 'Дворниченко Алексей',\n    phone: '+375 33 614 54 20',\n    photo: 'img/user.png'\n}, {\n    id: 2,\n    rank: 'КО 2',\n    name: 'Политыкин Денис',\n    phone: '+375 44 7864528',\n    photo: 'img/user.png'\n}];\n\nvar members = exports.members = [{\n    id: 2,\n    name: 'Барковский Андрей',\n    phone: '+375 44 7038013',\n    photo: 'img/user.png'\n}, {\n    id: 3,\n    name: 'Бродницкий Павел',\n    phone: '+375 00 000 00 00',\n    photo: 'img/user.png'\n}, {\n    id: 4,\n    name: 'Горбач Валентин',\n    phone: '+375 00 000 00 00',\n    photo: 'img/user.png'\n}, {\n    id: 6,\n    name: 'Жмойдяк Александр',\n    phone: '+375 29 9345024',\n    photo: 'img/user.png'\n}, {\n    id: 7,\n    name: 'Зайцев Илья',\n    phone: '+375 00 0000000',\n    photo: 'img/user.png'\n}, {\n    id: 8,\n    name: 'Захаров Ян',\n    phone: '+375 44 7713183',\n    photo: 'img/user.png'\n}, {\n    id: 9,\n    name: 'Зеньков Антон',\n    phone: '+375 00 0000000',\n    photo: 'img/user.png'\n}, {\n    id: 10,\n    name: 'Карпов Никита',\n    phone: '+375 44 4504835',\n    photo: 'img/user.png'\n}, {\n    id: 11,\n    name: 'Коваленко Алексей',\n    phone: '+375 33 3589510',\n    photo: 'img/user.png'\n}, {\n    id: 12,\n    name: 'Курило Алексей',\n    phone: '+375 00 000000',\n    photo: 'img/user.png'\n}, {\n    id: 14,\n    name: 'Поник Максим',\n    phone: '+375 29 8824865',\n    photo: 'img/user.png'\n}, {\n    id: 15,\n    name: 'Семитко Никита',\n    phone: '+375297751435',\n    photo: 'img/user.png'\n}, {\n    id: 17,\n    name: 'Тесловский Александр',\n    phone: '+375 33 6226599',\n    photo: 'img/user.png'\n}, {\n    id: 18,\n    name: 'Щербаков Роман',\n    phone: '+375 00 0000000',\n    photo: 'img/user.png'\n}, {\n    id: 1,\n    name: 'Агинский Владислав',\n    phone: '+375 29 3513163',\n    photo: 'img/user.png'\n}];\n\n//# sourceURL=webpack:///./src/js/Database.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nvar viewCaptainList = exports.viewCaptainList = function viewCaptainList(captains) {\n    var list = document.querySelector('.captains');\n    captains.forEach(function (cap) {\n        var capCard = '\\n            <div class=\"card card--captain\">\\n                <div class=\"user-photo\">\\n                    <img src=\"' + cap.photo + '\" alt=\"User Photo\">\\n                </div>\\n                <div class=\"user-inf\">\\n                    <div class=\"user-rank\">' + cap.rank + '</div>\\n                    <div class=\"user-name\">' + cap.name + '</div>\\n                    <div class=\"user-phone\">' + cap.phone + '</div>\\n                </div>\\n            </div>\\n        ';\n        list.insertAdjacentHTML('beforeend', capCard);\n    });\n};\n\nvar clearMembersList = exports.clearMembersList = function clearMembersList() {\n    var list = document.querySelector('.members-cards');\n    list.innerHTML = '';\n};\n\nvar viewMembersList = exports.viewMembersList = function viewMembersList(members) {\n    var list = document.querySelector('.members-cards');\n    members.forEach(function (member) {\n        var memberCard = '\\n            <div class=\"card\">\\n                <div class=\"user-photo\">\\n                    <img src=\"img/user.png\" alt=\"User Photo\">\\n                </div>\\n                <div class=\"user-inf\">\\n                    <div class=\"user-name\">' + member.name + '</div>\\n                    <div class=\"user-phone\">' + member.phone + '</div>\\n                </div>\\n            </div>\\n        ';\n        list.insertAdjacentHTML('beforeend', memberCard);\n    });\n};\n\nvar makeDuty = exports.makeDuty = function makeDuty() {\n    var person = Array.from(document.querySelectorAll('.card'))[3];\n    person.classList.add('duty');\n    person.insertAdjacentHTML('beforeend', '<img src=\"img/bookmark-star.png\" alt=\"Icon\" class=\"duty-icon\">');\n    person.querySelector('.user-inf').insertAdjacentHTML('beforeend', '<div class=\"user-duty\">\\u0414\\u0435\\u0436\\u0443\\u0440\\u043D\\u044B\\u0439</div>');\n};\n\n//# sourceURL=webpack:///./src/js/ListView.js?");
...
"use strict";
eval("\n\nvar _Database = __webpack_require__(/*! ./Database */ \"./src/js/Database.js\");\n\nvar data = _interopRequireWildcard(_Database);\n\nvar _ListView = __webpack_require__(/*! ./ListView */ \"./src/js/ListView.js\");\n\nvar listView = _interopRequireWildcard(_ListView);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nlistView.viewCaptainList(data.captains);\nlistView.viewMembersList(data.members);\nlistView.makeDuty();\n\nwindow.changeDuty = function () {\n    var wasDuty = data.members.shift();\n    var newDuty = data.members[0];\n    data.members.push(wasDuty);\n\n    listView.clearMembersList();\n    listView.viewMembersList(data.members);\n};\n\n//# sourceURL=webpack:///./src/js/index.js?");
